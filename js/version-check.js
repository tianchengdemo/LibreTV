...
async function checkForUpdates() {
    try {
        ...
        return {
            ...
            latest: currentVersion.trim(),
            hasUpdate: false,
            currentFormatted: formatVersion(currentVersion.trim()),
            latestFormatted: formatVersion(currentVersion.trim())
        };
    } catch (error) {
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/YOUR_USERNAME/Zhe.bi', '_blank');
                    });
                }
            }, 100);
        } else {
